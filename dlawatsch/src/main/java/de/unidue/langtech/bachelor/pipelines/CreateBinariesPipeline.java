...
public class CreateBinariesPipeline {
	...
	public static void writeToBinJCas(String corpusLocation, boolean islandic, boolean english, boolean german, boolean polnish, boolean latin) throws ResourceInitializationException, UIMAException, IOException{		
