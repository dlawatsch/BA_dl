...
import static de.unidue.langtech.bachelor.dlawatsch.TEICONSTANTS.ATTR_FUNCTION;
import static de.unidue.langtech.bachelor.dlawatsch.TEICONSTANTS.ATTR_LEMMA;
import static de.unidue.langtech.bachelor.dlawatsch.TEICONSTANTS.ATTR_POS;
import static de.unidue.langtech.bachelor.dlawatsch.TEICONSTANTS.ATTR_REALPOS;
import static de.unidue.langtech.bachelor.dlawatsch.TEICONSTANTS.ATTR_TYPE;
import static de.unidue.langtech.bachelor.dlawatsch.TEICONSTANTS.TAG_CHARACTER;
import static de.unidue.langtech.bachelor.dlawatsch.TEICONSTANTS.TAG_MULTIWORD;
import static de.unidue.langtech.bachelor.dlawatsch.TEICONSTANTS.TAG_PARAGRAPH;
import static de.unidue.langtech.bachelor.dlawatsch.TEICONSTANTS.TAG_PHRASE;
import static de.unidue.langtech.bachelor.dlawatsch.TEICONSTANTS.TAG_RS;
import static de.unidue.langtech.bachelor.dlawatsch.TEICONSTANTS.TAG_SYMBOL;
import static de.unidue.langtech.bachelor.dlawatsch.TEICONSTANTS.TAG_SUNIT;
import static de.unidue.langtech.bachelor.dlawatsch.TEICONSTANTS.TAG_TEI_DOC;
import static de.unidue.langtech.bachelor.dlawatsch.TEICONSTANTS.TAG_TEXT;
import static de.unidue.langtech.bachelor.dlawatsch.TEICONSTANTS.TAG_TITLE;
import static de.unidue.langtech.bachelor.dlawatsch.TEICONSTANTS.TAG_U;
import static de.unidue.langtech.bachelor.dlawatsch.TEICONSTANTS.TAG_WORD;
	...
	extends ResourceCollectionReaderBase
{
	...
	private boolean gotLemma = false;
	private boolean gotPOS = false;
...
//						currentResource.getLocation());
		...
		extends Handler
	{
		...
		public void startElement(String aUri, String aLocalName, String aName,
			...
			throws SAXException
		{
			System.out.printf("%b START %s %n", aUri, aLocalName, aName);
//			System.out.printf("%b START %s %n", captureText, aLocalName, aAttributes.getValue(aLocalName));
			if (!inTextElement && TAG_TEI_DOC.equals(aName)) {
            ...
            else if (inTextElement && "string".equals(aName)){
				...
				if (StringUtils.isNotEmpty(aAttributes.getValue(ATTR_POS))) {
	                ...
	                System.out.println("FOUND ATTRIBUTE: " + posTag);
				}
				else {
            ...
            else if (inTextElement && TAG_SYMBOL.equals(aName)){
            	tokenStart = getBuffer().length();
            	if (StringUtils.isNotEmpty(aAttributes.getValue(ATTR_REALPOS))) {
            		posTag = aAttributes.getValue(ATTR_REALPOS);
	                System.out.println("FOUND POS: " + posTag);
