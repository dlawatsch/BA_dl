  ...
  */  
  ...
  public int getID() {
    if (SequenceID_Type.featOkTst && ((SequenceID_Type)jcasType).casFeat_ID == null)
      jcasType.jcas.throwFeatMissing("ID", "de.unidue.langtech.bachelor.type.SequenceID");
  ...
  public int getNrOfTokens() {
    if (SequenceID_Type.featOkTst && ((SequenceID_Type)jcasType).casFeat_NrOfTokens == null)
      jcasType.jcas.throwFeatMissing("NrOfTokens", "de.unidue.langtech.bachelor.type.SequenceID");
  ...
  public int getBeginn() {
    if (SequenceID_Type.featOkTst && ((SequenceID_Type)jcasType).casFeat_Beginn == null)
      jcasType.jcas.throwFeatMissing("Beginn", "de.unidue.langtech.bachelor.type.SequenceID");
  ...
  public int getEnd() {
    if (SequenceID_Type.featOkTst && ((SequenceID_Type)jcasType).casFeat_End == null)
      jcasType.jcas.throwFeatMissing("End", "de.unidue.langtech.bachelor.type.SequenceID");
