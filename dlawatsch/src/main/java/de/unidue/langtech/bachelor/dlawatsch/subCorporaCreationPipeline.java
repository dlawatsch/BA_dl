	            ...
	            throws Exception
	        {
	            SimplePipeline.runPipeline(
	                    CollectionReaderFactory.createReader(
	                    		...
	                    		ReadBinJCasToJCasForModelGeneration.PARAM_SOURCE_LOCATION, "/home/dominik/Dokumente/BA/CORPORA/BINARIES/ISLANDICTEST/",
	                    		ReadBinJCasToJCasForModelGeneration.PARAM_PATTERNS, "Sentence*.bin",
	                    		ReadBinJCasToJCasForModelGeneration.PARAM_MAX_TOKEN_SIZE, "200"
	                    ),
