package de.unidue.langtech.bachelor.type;
...
/** 
 * Updated by JCasGen Tue Dec 15 20:39:55 CET 2015
 * @generated */
public class SequenceID_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.unidue.langtech.bachelor.type.SequenceID");
  ...
  public int getID(int addr) {
      ...
      jcas.throwFeatMissing("ID", "de.unidue.langtech.bachelor.type.SequenceID");
  ...
  public int getNrOfTokens(int addr) {
      ...
      jcas.throwFeatMissing("NrOfTokens", "de.unidue.langtech.bachelor.type.SequenceID");
  ...
  public int getBeginn(int addr) {
      ...
      jcas.throwFeatMissing("Beginn", "de.unidue.langtech.bachelor.type.SequenceID");
  ...
  public int getEnd(int addr) {
      ...
      jcas.throwFeatMissing("End", "de.unidue.langtech.bachelor.type.SequenceID");
